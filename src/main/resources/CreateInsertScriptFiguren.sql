DROP SCHEMA IF EXISTS `Figuren`;
CREATE SCHEMA `Figuren`;
USE `Figuren`;

CREATE USER IF NOT EXISTS 'userFiguren'@'localhost' IDENTIFIED BY 'userFigurenPW';
GRANT SELECT, INSERT ON Figuren . * TO 'userFiguren'@'localhost';
